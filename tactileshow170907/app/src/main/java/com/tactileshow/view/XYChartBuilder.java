...
import com.tactileshow.main.R.id;
...
public class XYChartBuilder extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(layout.xy_chart);
		
		// the top part of the UI components for adding new data points
		mX = (EditText) findViewById(id.xValue);
		mY = (EditText) findViewById(id.yValue);
		mAdd = (Button) findViewById(id.add);
		...
		mNewSeries = (Button) findViewById(id.new_series);
	...
	protected void onResume()
	{
		...
		if (mChartView == null)
		{
			LinearLayout layout = (LinearLayout) findViewById(id.chart);
			mChartView = ChartFactory.getCubeLineChartView(this, mDataset, mRenderer, 0.33f);
