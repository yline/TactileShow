...
public class Settings {
    ...
    private void BCDialog_Init() {
        ...
        et_di_min_temp = (EditText) di_setbc.findViewById(R.id.setting_bc_et_tempmin); // 温度
        et_di_max_temp = (EditText) di_setbc.findViewById(R.id.setting_bc_et_tempmax);
        et_di_per_temp = (EditText) di_setbc.findViewById(R.id.setting_bc_et_tempper); // 周期
        ...
        et_di_min_press = (EditText) di_setbc.findViewById(R.id.setting_bc_et_pressmin); // 湿度
        et_di_max_press = (EditText) di_setbc.findViewById(R.id.setting_bc_et_pressmax);
        et_di_per_press = (EditText) di_setbc.findViewById(R.id.setting_bc_et_pressper); // 周期
