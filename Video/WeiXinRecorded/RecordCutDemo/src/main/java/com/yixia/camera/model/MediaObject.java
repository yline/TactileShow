...
public class MediaObject implements Serializable {
     ...
     * 获取所有分块
     */
    private LinkedList<MediaPartModel> mMediaList = new LinkedList<MediaPartModel>();
    ...
    public String getConcatYUV() {
        ...
        if (mMediaList != null && mMediaList.size() > 0) {
            if (mMediaList.size() == 1) {
                if (StringUtils.isEmpty(mMediaList.get(0).getTempMediaPath())) {
                ...
                for (int i = 0, j = mMediaList.size(); i < j; i++) {
                    ...
                    if (StringUtils.isEmpty(part.getTempMediaPath())) {
    ...
    public String getConcatPCM() {
        ...
        if (mMediaList != null && mMediaList.size() > 0) {
            if (mMediaList.size() == 1) {
                if (StringUtils.isEmpty(mMediaList.get(0).getTempAudioPath())) {
                ...
                for (int i = 0, j = mMediaList.size(); i < j; i++) {
                    MediaPartModel part = mMediaList.get(i);
                    if (StringUtils.isEmpty(part.getTempAudioPath())) {
