...
public class Macro
{
    ...
    //低功耗蓝牙(BLE)
    public static String UUID_BLE_SER = "0000fff0-0000-1000-8000-00805f9b34fb"; //rx服务uuid
    
    public static String UUID_BLE_DAT = "0000fff6-0000-1000-8000-00805f9b34fb"; //notify
    
    public static String UUID_BLE_CON = "0000fff1-0000-1000-8000-00805f9b34fb"; //
