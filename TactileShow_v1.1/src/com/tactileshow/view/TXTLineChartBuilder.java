...
public class TXTLineChartBuilder {
	  ...
	  public TXTLineChartBuilder(Context context, LinearLayout layout, String title, DefinedViewPager pager, DefinedScrollView scroll){
	  ...
	  public void init() {
		    ...
		    List<String> ls = DataReader.getDataList();
